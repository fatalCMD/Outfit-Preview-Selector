...
- Added five pages with ten outfits per page.
- Added an equipping indicator and missing-item notice.
- Improved widescreen scaling, mouse handling, and menu stability.
- Improved HDT-SMP preview physics support.

## 1.0.0

- Initial release.
- Added ten named outfit slots.
- Added the paused character preview and MCM settings.
